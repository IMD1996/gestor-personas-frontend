...
async function cargarPersonas() {
  ...
  try {
    ...
    const response = await apiFetch(`${API_URL}/personas`);
...
async function confirmarEliminar() {
  ...
  try {
    ...
    const response = await apiFetch(`${API_URL}/personas/${idAEliminar}`, {
  method: "DELETE"
});
...
async function editarPersona() {
  ...
  try {
    const response = await apiFetch(`${API_URL}/personas/${id}`, {
  method: "PUT",
  headers: {
    "Content-Type": "application/json"
  },
